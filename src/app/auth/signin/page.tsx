  ...
  return (
    <div className="min-h-screen hero-gradient flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        {/* Card */}
        <div className="bg-white rounded-3xl border border-gray-200 p-8 card-shadow">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 border border-gray-200 hover:bg-gray-50 rounded-xl py-3 font-bold text-gray-700 transition mb-5 disabled:opacity-60"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input type={showPass ? "text" : "password"} value={password} onChange={e => setPassword(e.target.value)} required autoComplete="current-password"
                  className="w-full bg-white border border-gray-300 focus:border-violet-500 focus:ring-1 focus:ring-violet-500 rounded-xl px-4 py-3 pr-11 text-sm text-gray-900 outline-none transition placeholder-gray-400"
                  placeholder="••••••••" />
            ...
            <button type="submit" disabled={loading}
              className="w-full btn-primary text-white py-3 rounded-xl font-black transition flex items-center justify-center gap-2 disabled:opacity-60">
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            No account?{" "}
            <Link href="/auth/signup" className="text-violet-600 font-black hover:text-violet-700 transition">Sign up free</Link>
          </p>
        </div>
